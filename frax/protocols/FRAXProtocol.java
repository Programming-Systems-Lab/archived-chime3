...
package psl.chime.frax.protocols;
import psl.chime.frax.plugs.*;
import java.io.*;
import java.lang.*;

public abstract class FRAXProtocol {
     ...
     * @params: pass_to_plug - see makeParams()
     */
    public boolean goPlug(String PROTOCOL_NAME, String OBJECT, Object[] pass_to_plug) {
	PlugStarter ps = new PlugStarter();
	ps.findAndRunPlug(PROTOCOL_NAME, OBJECT,  pass_to_plug);
	return true;
    }
    
    /**
     * Helper method to make the parameters necessary for the last argument of goPlug
     ...
     **/
    public Object[] makeParams(String addon, DataInputStream ds, Long value) {
